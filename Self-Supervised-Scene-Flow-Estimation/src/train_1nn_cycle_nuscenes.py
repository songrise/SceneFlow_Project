...
#! Re: modified from https://github.com/xingyul/flownet3d/blob/master/train.py
import pickle
import argparse
import math
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:' + str(GPU_INDEX)):
            ...
            pointclouds_pl = MODEL.placeholder_inputs(
                BATCH_SIZE, NUM_POINT, NUM_FRAMES)
            # ipdb.set_trace()
...
def get_batch(dataset, idxs, start_idx, end_idx):
    ...
    #! Re: FPS should be refering to Farthest Point Sampling
